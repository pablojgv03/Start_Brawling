...
public class RecyclerAdapter_Maps extends RecyclerView.Adapter<RecyclerAdapter_Maps.RecyclerHolder> {
    public ArrayList<Maps_Class> listMaps;
    Context context;
    private CircularProgressDrawable progressDrawable;

    public RecyclerAdapter_Maps(Context context)
    {
        this.context = context;
        listMaps = new ArrayList<Maps_Class>();
    }
    public void add(Maps_Class maps){
        listMaps.add(maps);
    ...
    public RecyclerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        // de ejecución
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_item_list_map,parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerHolder holder, int position) {
        ...
        Maps_Class map = listMaps.get(position);
        holder.txtViewTitle.setText(map.getName());
        holder.txtViewDesc.setText(map.getModo());
        Glide.with(context)
                .load(map.getEfoto())
